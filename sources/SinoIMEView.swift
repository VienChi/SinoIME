...
private class SinoIMELayoutDelegate: NSObject, NSTextLayoutManagerDelegate {
...
final class SinoIMEView: NSView {
  let textView: NSTextView

  private let sinoimeLayoutDelegate: SinoIMELayoutDelegate
  ...
  var lightTheme = SinoIMETheme()
  var darkTheme = SinoIMETheme()
  var currentTheme: SinoIMETheme {
  ...
  override init(frame frameRect: NSRect) {
    sinoimeLayoutDelegate = SinoIMELayoutDelegate()
    textView = NSTextView(frame: frameRect)
    textView.drawsBackground = false
    textView.isEditable = false
    textView.isSelectable = false
    textView.textLayoutManager?.delegate = sinoimeLayoutDelegate
...
private extension SinoIMEView {
  ...
  func pagingLayer(theme: SinoIMETheme, preeditRect: CGRect) -> (CAShapeLayer, CGPath?, CGPath?) {
    let layer = CAShapeLayer()
